...
<body class="bg-gradient-primary" style="background-image: url('https://wallpapercrafter.com/th800/250437-stacks-of-shipping-containers-in-the-port-of-barce.jpg')">
      ...
      <div class="col-xl-10 col-lg-12 col-md-9 mt-5">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-6 d-none d-lg-block bg-login-image"style="background-image: url('https://designfor-me.com/wp-content/uploads/2016/02/Container-Guest-House-in-San-Antonio-by-Poteet-Architects.jpg')"></div>
              <div class="col-lg-6">
                <div class="p-5">
